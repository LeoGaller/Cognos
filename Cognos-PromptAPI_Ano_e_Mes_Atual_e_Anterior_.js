<script>
   ...
   //setting the last month
	function setPromptMesAnt(promptName){
	
		var oP1 = ocr.prompt.getControlByName(promptName);
        oP1.setValues([{'use' : mesAnt()}]);
	}//end of last month
...
<script>setPromptMes('PMes');</script>

<script>setPromptMesAnt('PMesAnt');</script>
