<script>
    ...
    function lastOfMonth() {
        ...
        var dtLastOfMonth = new Date(dtToday.getFullYear(), dtToday.getMonth() + 1, 0);

        var strLastOfMonth = [dtLastOfMonth.getUTCFullYear(), dtLastOfMonth.getMonth() + 1,
            dtLastOfMonth.getDate()
        ].join("-");
